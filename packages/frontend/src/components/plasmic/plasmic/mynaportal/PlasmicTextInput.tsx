...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: SUHChT6biWAS/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: EcxaVyqqbSLH/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__yl20I)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__qrA3D)}
              role={"img"}
            />
          ),

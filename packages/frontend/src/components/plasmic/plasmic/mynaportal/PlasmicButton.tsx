...
import sty from "./PlasmicButton.module.css"; // plasmic-import: tNzsSEy0iSL1/css
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.root___focusVisibleWithin_color_yellow]:
          ...
          [sty.rootcolor_yellow_showEndIcon]:
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg___4Gm4T)}
                role={"img"}
              />
            ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          [sty.contentContainer___focusVisibleWithin]:
            triggers.focusVisibleWithin_root,
          [sty.contentContainercolor_gray]: hasVariant($state, "color", "gray"),
      ...
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_yellow_showEndIcon]:
              hasVariant($state, "color", "yellow") &&
              hasVariant($state, "showEndIcon", "showEndIcon"),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__p5Ob0)}
                role={"img"}
              />
            ),
